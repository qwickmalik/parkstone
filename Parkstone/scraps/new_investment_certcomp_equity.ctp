        ...
        <table id="payment_receipt" border="0" width="700px" cellspacing="0" cellpadding="5" align="center" style="border: solid 15px Navy;">
            ...
            <tr>
                <td align="center" valign="top" colspan="2">
                    ...
                    <?php if (isset($investment_array['Investor']['comp_name'])) {
                        ?><b style="font-size: 18px;"> <br /><i style="color: Navy;"><?php
                        if (isset($investment_array['Investor']['comp_name'])) {
                            echo $investment_array['Investor']['comp_name'];
                        } else {
                            echo '';
                        }
                        ?></i></b>
...
//if (isset($investment_array['Portfolio']['payment_name'])) {
...
?></span></td>
                        ...
                        <tr><?php if (isset($investment_array['InvestmentTerm']['term_name'])) { ?>
                            ...
                            elseif (isset($investment_array['Investment']['equity'])) { ?>
                            <td><b align="right">Investment Term:</b></td>
                                <td><span id="xxxxxx"><? echo $investment_array['Investment']['equity'];
                                ?>   </span></td> <?php
                            }?>
                        </tr> 
                        <tr>
                            ...
                            <td><span id="xxxxxx"><?php
                                    if (isset($investment_array['Investment']['custom_rate'])) {
        ...
        <!--                <tr>
                            ...
                            <td><span id="xxxxxx"><?php
                        //if (isset($payment['Rate']['interest_rate'])) {
...
//} 
        ...
        <!--                <tr>
                            ...
                            <td><span id="xxxxxx"><?php
                                    // if (isset($payment['Order']['tax_charge'])) {
