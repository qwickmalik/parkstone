...
<div class="boxed">
    ...
    <?php
    echo $this->Form->create('DelFixedInvestmentDeposits', array("url" => array('controller' => 'Reinvestments', 'action' => 'delFixedInvestmentDeposits'), "inputDefaults" => array('label' => false, 'div' => false)));
    ?>
