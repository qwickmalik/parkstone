...
<div class="boxed">
    <div class="inner">
        ...
        <?php echo $this->Form->create('Investment', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'Investments', 'action' => 'searchInvest4mInvest2'), "inputDefaults" => array('div' => false))); ?>
...
//   echo $this->Form->create('Investment', array("url" => array('controller' => 'Investments', 'action' => '#'), "inputDefaults" => array('label' => false, 'div' => false)));
        ...
        <table border="0" width="100%" cellspacing="5" cellpadding="5" align="left" style="font-size:85%">
            <tr>
                ...
                <td style="border-bottom: solid 2px dodgerblue;" align="left"><b><?php echo 'Manage Equity Inv.'; ?></b></td>
            </tr>
                <?php
                if (isset($data)) {
...
//                        echo $this->Html->link($each_item['Investor']['fullname'], "/Investments/searchInvest4mInvest/" . $each_item['Investor']['id'] . "/manage", array());
            ...
            <?php echo $each_item['InvestorType']['investor_type']; ?>
                ...
                <td align="left"><?php 
                    ...
                    echo $this->Html->link('View', "/Reinvestments/manageEquityInvestments/" . (isset($each_item['Investor']['id']) ? $each_item['Investor']['id'] . "/" . $each_item['Investor']['fullname'] : '' ));
                ?></td>
