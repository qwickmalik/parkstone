...
<div class="boxed">
    <div class="inner">
        ...
        <?php echo $this->Form->create('EquitiesList', array("url" => array('controller' => 'Settings', 'action' => 'equitiesList'), "inputDefaults" => array('label' => false, 'div' => false))); ?>
        ...
        <table border="0" width="100%" cellspacing="10" cellpadding="0" align="left">
            ...
            <tr>
                ...
                <td>
                    <?php 
                    echo $this->Form->input('equity_name', array("size" => 40));
                    echo $this->Form->input('equity_abbrev', array("size" => 40));
...
<?php foreach ($data as $each_item): ?>
    ...
    <?php echo $this->Html->link($each_item['EquitiesList']['equity_name'], "#", array("class" => $each_item['EquitiesList']['id'])); ?>
                        </td> <!-- Link to enable editing -->
                        <td width="20" align="left">
                            <?php echo $this->Html->link("Delete", "/Settings/delPaymentName/" . $each_item['EquitiesList']['id'], array("class" => $each_item['EquitiesList']['id']));
                            ?>
                        </td>
                    </tr>
<?php endforeach; ?>
