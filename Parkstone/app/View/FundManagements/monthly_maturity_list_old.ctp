...
<div class="boxed">
    <div class="inner">
        ...
        <!-- Content start here -->
        <div class="row">
            <?php echo $this->Form->create('Reinvestment', array('url' => array('controller' => 'FundManagements', 'action' => 'monthlyMaturityList'))); ?>
...
<?php 
                    ...
                    <tr style="border-bottom: solid 1px silver;font-size: 13px;">
                                ...
                                <td align="left"><?php echo $this->Html->link((!empty($each_item['Reinvestor']['company_name']) ? $each_item['Reinvestor']['company_name'] : '' ),"/FundManagements/approvePayments2/".(isset($each_item['Reinvestor']['id']) ? $each_item['Reinvestor']['id']."/".$each_item['Reinvestor']['company_name'] : '' ),array());  ?></td>
