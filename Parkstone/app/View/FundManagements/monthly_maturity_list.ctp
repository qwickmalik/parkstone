...
<h3>Fund Management - Monthly Maturity List For Period <?php echo $frstart_date; ?> - <?php echo $frend_date; ?></h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
        ...
        <div class="row"><?php echo $this->Form->create('Reinvestment', array('url' => array('controller' => 'FundManagements', 'action' => 'monthlyMaturityList'))); ?>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <table border="0" width="100%" cellspacing="5" cellpadding="5" align="left" style="font-size: 87%">
                    ...
                    <tr >
                        ...
                        <td style="border-bottom: solid 2px dodgerblue" align="left"><b><?php echo  'Company'; ?></b></td>
