...
?>
<h3>Fund Management - New Investment Summary</h3>
<div class="boxed">
	<div class="inner">
            <div id="clearer"></div>
...
<table cellspacing="0" cellpadding="0" border="0" align="left" width="700px">
	...
	<tr>
		...
		<td align="right" valign="top" width="50%">
			<?php 
				echo $this->Html->link('Return',"/FundManagements/newInvestment",array('style' =>'font-size: 14px;', 'class'=>'btn btn-lg btn-info')); 
