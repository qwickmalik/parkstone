...
<div class="boxed">
    <div class="inner">
        ...
        <?php echo $this->Form->create('ListCashDeposits', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'FundManagements', 'action' => 'searchreinvestor4list'), "inputDefaults" => array('div' => false))); ?>
                ...
                <tr>
                    ...
                    <td align="center">
                        <?php if($each_item['Reinvestment']['status'] == 'Invested' || 
                            ...
                            echo $this->Html->link("Details","/FundManagements/manageInvFixedDetails/".$each_item['Reinvestment']['id']);  
                            echo " | ";
                            echo $this->Html->link("Terminate","/FundManagements/terminateFixedInvestment/".$each_item['Reinvestment']['id']."/".$each_item['Reinvestment']['reinvestor_id']);  
//                           
                            ...
                            echo $this->Html->link("Roll-over","/FundManagements/rollover/".$each_item['Reinvestment']['id']."/".$each_item['Reinvestment']['reinvestor_id']);
                            //rolloverReinvestorFixed
                            echo " | ";
                            echo $this->Html->link("Record Inv. Returns","/FundManagements/payReinvestorFixed/".$each_item['Reinvestment']['id']);  
                            }elseif($each_item['Reinvestment']['status'] == 'Terminated' &&( $each_item['Reinvestment']['payment_status'] == 'unpaid' || $each_item['Reinvestment']['payment_status'] == 'part_payment')){
...
//                       
                ...
                <td align="center"><?php // echo $this->Html->Link('Statement', '/FundManagements/statementDailyInterest'."/".(isset($each_item['Reinvestment']['id']) ? $each_item['Reinvestment']['id'] : '' )."/".(isset($each_item['Reinvestment']['reinvestor_id']) ? $each_item['Reinvestment']['reinvestor_id'] : '' )."/".(isset($each_item['Reinvestor']['fullname']) ? $each_item['Reinvestor']['fullname'] : '' ),array('escape'=>false));?></td>
...
//                    echo $this->Html->Link('Top-up', '#topUpForm'."/".(isset($each_item['Reinvestment']['id']) ? $each_item['Reinvestment']['id'] : '' ),array('escape'=>false, 'class' => 'btn btn-xs btn-success topup','data-id' => (isset($each_item['Reinvestment']['id']) ? $each_item['Reinvestment']['id'] : '' ),'data-toggle' => 'modal', 'data-target' => '#topUpForm'));
                 echo $this->Html->Link('Top-up', "/FundManagements/topup/".(isset($each_item['Reinvestment']['id']) ? $each_item['Reinvestment']['id'] : '' )."/".(isset($each_item['Reinvestment']['reinvestor_id']) ? $each_item['Reinvestment']['reinvestor_id'] : '' ),array('escape'=>false, 'class' => 'btn btn-xs btn-success '));
...
//                            echo $this->Html->link('Delete', '/FundManagements/delFixedInvestmentDeposits/'.$reinvestor_id.'/'.$each_item['Reinvestment']['id'], array('class' => 'btn btn-xs btn-warning'));
                        }
                        ?></td>
                <td align="center"><?php
                        if(isset($each_item['Reinvestment']['id'])){
//                            echo $this->Html->link('Delete', '/FundManagements/delFixedInvestmentPayments/'.$reinvestor_id.'/'.$each_item['Reinvestment']['id'], array('class' => 'btn btn-xs btn-danger'));
                        }
                        ?></td>
                </tr>
<?php endforeach; ?>
