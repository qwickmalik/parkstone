...
?>
<!-- Content starts here -->
<h3 style="color: red;">Fund Management - New Investment</h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
        ...
        <p class="subtitle-red">Step 3 - Finished (Summary)</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <?php echo (isset($reinvestments['Reinvestment']['investment_amount']) ?
                                           'GH$ '. number_format($reinvestments['Reinvestment']['investment_amount'], 2) : '' );?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <?php echo (isset($reinvestments['Reinvestment']['accrued_interest']) ? 
                                            'GH$ '. number_format($reinvestments['Reinvestment']['accrued_interest'], 2)
                                             : '' );?>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <?php echo (isset($reinvestments['Reinvestment']['amount_due']) ? 
                                            'GH$ '. number_format($reinvestments['Reinvestment']['amount_due'], 2) : '' );?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12" style="text-align: right;">
                    <?php
                    echo "<p>&nbsp;</p>";
                    echo $this->Html->link('New Investment', "/FundManagements/newInvestment", array("class" => 'btn btn-lg btn-info'));
                    echo "&nbsp;&nbsp;";
