...
<div class="boxed">
    <div class="inner">
        ...
        <?php
        echo $this->Form->create('Reinvestment', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'FundManagements', 'action' => 'process_fixd'), "inputDefaults" => array('div' => false)));
...
//                    echo $this->Html->link('Back', "/FundManagements/newInvestment", array("class" => 'btn btn-lg btn-info'));
                    ...
                    echo "&nbsp;&nbsp;";
                    echo $this->Html->link('Submit', "/FundManagements/newInvestment1Fixed1/".(isset($reinvestorcashaccounts['ReinvestorCashaccount']['reinvestor_id']) ? $reinvestorcashaccounts['ReinvestorCashaccount']['reinvestor_id'] : '' ), 
