...
?>
<!-- Content starts here -->
<h3 style="color: red;">Fund Management - New Cash Deposit - Step 2</h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="5" align="left">
            ...
            <tr>
                <td align="left" valign="top" colspan="3" style="font-size: 18px; color: red; font-weight: bold;">Investor Details</td>
            </tr>
            <tr>
                <td align="left" valign="top" colspan="3">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <b>ID:</b> <?php if (isset($data['Reinvestor']['id'])) {
    echo $data['Reinvestor']['id'];
} ?><br>
                            <b>Company Name:</b> <?php if (isset($data['Reinvestor']['company_name'])) {
    echo $data['Reinvestor']['company_name'];
} ?><br>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <b>Address:</b> <?php if (isset($data['Reinvestor']['postal_address'])) {
    echo $data['Reinvestor']['postal_address'];
} ?><br>
                        </div>
                    </div>
                </td>
...
<?php
echo $this->Form->create('InvestmentCash', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'FundManagements', 'action' => 'addCashDeposit'), "inputDefaults" => array('div' => false)));
?>
                    <div class="row" style="background: #F0E3C0;">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            echo $this->Form->hidden('currency_id', array( 'value' => 1,'empty' => '--Please select currency--',));

                            echo $this->Form->input('currency_id2', array("disabled", 'type' => 'select', 'label' => 'Currency', 'options' => $currencies, 'empty' => '--Please select currency--', 'selected' => 1));
...
<?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 40px; padding: 10px 0px 10px 0px;'>&nbsp;</span>" . $this->Form->year('investment_date', 1950, date('Y'), array("required", "selected" => $Year)); ?>
            ...
            <tr>
                ...
                <td align="right" valign="middle" colspan="2">
                    <?php echo $this->Html->link('Back', "/FundManagements/newCashDeposit", array("class" => 'btn btn-lg btn-info')); ?>
...
<?php echo $this->element('footer'); ?>
    <script lang="javascript">
        jQuery(document).ready(function ($) {
            hide_investcolumn();
            $("#InvestmentCashInvestmentproductId").change(function () {
            ...
            function hide_investcolumn() {
                var prod_val = $("#InvestmentCashInvestmentproductId").val();
    //             $(".hidden-fee").hide();
                if (prod_val == "1") {

                    $("#InvestmentCashFixedInvAmount").prop("disabled", false);
                    $("#InvestmentCashEquityInvAmount").prop("disabled", true);
                }

                if (prod_val == "2") {
//                    $("#InvestmentInvestmentPeriod").prop("disabled", true);
                    $("#InvestmentCashEquityInvAmount").prop("disabled", false);
                    $("#InvestmentCashFixedInvAmount").prop("disabled", true);
                }
