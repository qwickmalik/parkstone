        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="5" align="left">
            ...
            <tr>
                <td align="left" valign="top" colspan="3">
                    ...
                    <?php
                    echo $this->Form->create('ReinvestorDeposit', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'FundManagements', 'action' => 'editCashDeposit'), "inputDefaults" => array('div' => false)));
                    ?>
