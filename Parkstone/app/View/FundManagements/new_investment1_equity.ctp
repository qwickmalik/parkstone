...
<div class="boxed">
    <div class="inner">
        ...
        <?php
        echo $this->Form->create('Reinvestment', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'FundManagements', 'action' => 'process_equity'), "inputDefaults" => array('div' => false)));
        ?>
...
//                                    }
                ...
                <div class="col-lg-12 col-md-12 col-sm-12" style="text-align: right;">
                    ...
                    echo "&nbsp;&nbsp;";
                    echo $this->Html->link('Submit', "/FundManagements/newInvestment1Equity1/".(isset($equitydetails['InvestmentCash']['reinvestor_id']) ? 
