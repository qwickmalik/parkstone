...
<!-- Step Investment Details Start -->
                    <?php
                    echo $this->Form->create('Reinvestment', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'FundManagements', 'action' => 'newInvestment'), "inputDefaults" => array('div' => false)));
                    ?>
        <table border="0" width="100%" cellspacing="0" cellpadding="5" align="left">
            ...
            <tr>
                <td align="left" valign="top" colspan="3">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        echo $this->Form->input('reinvestor_id', array('label' => 'Company','empty' => '--Please Select --'));
                        ?>  
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <?php
            ...
            <tr>
                <td align="right" valign="middle" colspan="3">
                    <?php 
//                        echo $this->Html->link('Clear', "/FundManagements/newInvestment", array("class" => 'btn btn-lg btn-info')); 
