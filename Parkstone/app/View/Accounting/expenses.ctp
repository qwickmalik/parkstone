...
<div id="clearer"></div>
    ...
    <table class="table table-striped">
        <tr>
            ...
            <th style="border-bottom: solid 2px dodgerblue;" align="left"><b><?php echo $this->Paginator->sort('category_id', 'Expense Category'); ?></b></th>
        ...
        foreach ($data as $each_item):
            ...
            <tr>
                ...
                <td align="right"><?php echo $this->Html->link(number_format($each_item['Transaction']['amount'], 2, '.', ','), '/Accounting/expenses/' . $each_item['Transaction']['id']); ?></td>
                ...
                <td align="left"><?php echo $this->Html->link('Del', '/Accounting/delExpense/' . $each_item['Transaction']['id'], array('confirm' => 'Are you sure you want to delete?')); ?></td>
            </tr>
        <?php endforeach; ?>
