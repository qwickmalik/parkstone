          ...
          <div class="inner">
            ...
            <div class="step-content">
              <!--<form method="post" action="#" id="wizard-form-data" class="basic-form horizontal-form">-->
				<?php
				echo $this->Form->create('Investor', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'Investments', 'action' => 'commit_joint'), "inputDefaults" => array('div' => false))); 
				?>
...
<!--					<div class="col-lg-3 col-md-3 col-sm-12">
					...
					<div class="col-lg-3 col-md-3 col-sm-12">
                        ...
                        <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>Issue Date*:</span>".$this->Form->day('id_issue', array('size' => 1, 'label'=>'Issue Date*','value' => (isset($investor['Investor']['id_issue']) ? date('d',strtotime($investor['Investor']['id_issue'])) : date('d') ),'empty' => (isset($investor['Investor']['id_issue']) ? date('d',strtotime($investor['Investor']['id_issue'])) : date('d') ), 'class' => 'required'));  ?>&nbsp;
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>&nbsp;</span>".$this->Form->month('id_issue', array('size' => 1, 'label'=>false,'value' => (isset($investor['Investor']['id_issue']) ? date('m',strtotime($investor['Investor']['id_issue'])) : date('m') ),'empty' => (isset($investor['Investor']['id_issue']) ? date('F',strtotime($investor['Investor']['id_issue'])) : date('F') ), 'class' => 'required')); ?>&nbsp;
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>&nbsp;</span>".$this->Form->year('id_issue', 1950, date('Y'), array("id" => "is_year", 'type' => 'date', 'dateFormat' => 'Y','size' => 1, "style" => "margin-right: 10px;",'label'=>false,'value' => (isset($investor['Investor']['id_issue']) ? date('Y',strtotime($investor['Investor']['id_issue'])) : date('Y') ),'empty' => (isset($investor['Investor']['id_issue']) ? date('Y',strtotime($investor['Investor']['id_issue'])) : date('Y')), 'class' => 'required')); ?>
                	</div>
				</div>
				
                         <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>Expiry Date:</span>".$this->Form->day('id_expiry', array('size' => 1, 'label'=>'Expiry Date','value' => (isset($investor['Investor']['id_issue']) ? date('d',strtotime($investor['Investor']['id_expiry'])) : date('d') ),'empty' => (isset($investor['Investor']['id_expiry']) ? date('d',strtotime($investor['Investor']['id_expiry'])) : date('d') ), 'class' => 'required'));  ?>&nbsp;
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>&nbsp;</span>".$this->Form->month('id_expiry', array('size' => 1, 'label'=>false,'value' => (isset($investor['Investor']['id_issue']) ? date('m',strtotime($investor['Investor']['id_expiry'])) : date('m') ),'empty' => (isset($investor['Investor']['id_expiry']) ? date('F',strtotime($investor['Investor']['id_expiry'])) : date('F') ), 'class' => 'required')); ?>&nbsp;
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>&nbsp;</span>".$this->Form->year('id_expiry', 1950, date('Y'), array("id" => "is_year", 'type' => 'date', 'dateFormat' => 'Y','size' => 1, "style" => "margin-right: 10px;",'label'=>false,'value' => (isset($investor['Investor']['id_expiry']) ? date('Y',strtotime($investor['Investor']['id_expiry'])) : date('Y') ),'empty' => (isset($investor['Investor']['id_expiry']) ? date('Y',strtotime($investor['Investor']['id_expiry'])) : date('Y')), 'class' => 'required')); ?>
                	</div>
				</div>
					<?php
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
                      <?php
						...
						echo $this->Form->input('position_held', array('value' => (isset($investor['Investor']['position_held']) ? $investor['Investor']['position_held'] : '' ), 'placeholder' => 'Enter position held at work'));
                                                ...
                                                echo $this->Form->radio('marital_status',array("Single" => "Single","Married" => "Married",'Widowed' => 'Widowed','Divorced' => 'Divorced'), array('hiddenField' => false,'value' => (isset($investor['Investor']['marital_status']) ? $investor['Investor']['marital_status'] : '' ), 'placeholder' => 'Enter marital status'));
                ...
                <!-- Step 2 Joint Account Holder Form Start -->
                <div class="step-pane" id="step2">
                  <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <?php 
						echo $this->Form->input('j_surname', array('label' => 'Surname*','value' => (isset($investor['Investor']['j_surname']) ? $investor['Investor']['j_surname'] : '' ), 'placeholder' => 'Enter surname', 'class' => 'required')); 
						echo $this->Form->input('j_other_names', array('label' => 'Other Names*','value' => (isset($investor['Investor']['j_other_names']) ? $investor['Investor']['j_other_names'] : '' ), 'placeholder' => 'Enter other name(s)', 'class' => 'required'));
						echo $this->Form->input('j_postal_address', array('label' => 'Postal Address', 'value' => (isset($investor['Investor']['j_postal_address']) ? $investor['Investor']['j_postal_address'] : '' ), 'placeholder' => 'Enter postal address'));
						echo $this->Form->input('j_phone', array('label' => 'Phone Number*','value' => (isset($investor['Investor']['j_phone']) ? $investor['Investor']['j_phone'] : '' ), 'placeholder' => 'Enter phone number', 'class' => 'required'));
						echo $this->Form->input('j_email', array('label' => 'Email Address*','value' => (isset($investor['Investor']['j_email']) ? $investor['Investor']['j_email'] : '' ), 'placeholder' => 'Enter email address', 'class' => 'required'));
						?>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="row">
						<div class="col-lg-4 col-md-4 col-sm-12">
							<?php echo $this->Form->input('j_id_type', array('label' => 'ID Type', 'value' => (isset($investor['Investor']['j_id_type1']) ? $investor['Investor']['j_id_type1'] : 'Drivers license' ),'options' => array("Drivers license"=>"Drivers license",'NHIS','National ID','Passport','Voter ID'))); ?>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-12">
							<?php echo $this->Form->input('j_id_number', array('label' => 'ID Number', 'value' => (isset($investor['Investor']['j_id_number1']) ? $investor['Investor']['j_id_number1'] : '' ), 'placeholder' => 'Enter ID number')); ?>
						</div>
<!--						<div class="col-lg-3 col-md-3 col-sm-12">
							<?php //echo $this->Form->input('j_id_issue', array('label' => 'Issue Date', 'value' => (isset($investor['Investor']['j_id_issue1']) ? $investor['Investor']['j_id_issue1'] : '' ), 'placeholder' => 'dd/mm/yyyy')); ?>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-12">
							<?php //echo $this->Form->input('j_id_expiry', array('label' => 'Expiry Date', 'value' => (isset($investor['Investor']['j_id_expiry1']) ? $investor['Investor']['j_id_expiry1'] : '' ), 'placeholder' => 'dd/mm/yyyy')); ?>
						</div>-->
			
					</div>
                        <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>Issue Date*:</span>".$this->Form->day('j_id_issue', array('size' => 1, 'label'=>'Issue Date*','value' => (isset($investor['Investor']['j_id_issue']) ? date('d',strtotime($investor['Investor']['j_id_issue'])) : date('d') ),'empty' => (isset($investor['Investor']['j_id_issue']) ? date('d',strtotime($investor['Investor']['j_id_issue'])) : date('d') ), 'class' => 'required'));  ?>&nbsp;
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>&nbsp;</span>".$this->Form->month('j_id_issue', array('size' => 1, 'label'=>false,'value' => (isset($investor['Investor']['j_id_issue']) ? date('m',strtotime($investor['Investor']['j_id_issue'])) : date('m') ),'empty' => (isset($investor['Investor']['j_id_issue']) ? date('F',strtotime($investor['Investor']['j_id_issue'])) : date('F') ), 'class' => 'required')); ?>&nbsp;
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>&nbsp;</span>".$this->Form->year('j_id_issue', 1950, date('Y'), array("id" => "is_year", 'type' => 'date', 'dateFormat' => 'Y','size' => 1, "style" => "margin-right: 10px;",'label'=>false,'value' => (isset($investor['Investor']['j_id_issue']) ? date('Y',strtotime($investor['Investor']['j_id_issue'])) : date('Y') ),'empty' => (isset($investor['Investor']['j_id_issue']) ? date('Y',strtotime($investor['Investor']['j_id_issue'])) : date('Y')), 'class' => 'required')); ?>
                	</div>
				</div>
				
                         <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>Expiry Date:</span>".$this->Form->day('j_id_expiry', array('size' => 1, 'label'=>'Expiry Date','value' => (isset($investor['Investor']['j_id_issue']) ? date('d',strtotime($investor['Investor']['j_id_expiry'])) : date('d') ),'empty' => (isset($investor['Investor']['j_id_expiry']) ? date('d',strtotime($investor['Investor']['j_id_expiry'])) : date('d') ), 'class' => 'required'));  ?>&nbsp;
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>&nbsp;</span>".$this->Form->month('j_id_expiry', array('size' => 1, 'label'=>false,'value' => (isset($investor['Investor']['j_id_issue']) ? date('m',strtotime($investor['Investor']['j_id_expiry'])) : date('m') ),'empty' => (isset($investor['Investor']['j_id_expiry']) ? date('F',strtotime($investor['Investor']['j_id_expiry'])) : date('F') ), 'class' => 'required')); ?>&nbsp;
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12">
					  <?php echo "<span style='font-size: 14px;font-weight: bold;line-height: 20px; padding: 10px 0px 10px 0px;'>&nbsp;</span>".$this->Form->year('j_id_expiry', 1950, date('Y'), array("id" => "is_year", 'type' => 'date', 'dateFormat' => 'Y','size' => 1, "style" => "margin-right: 10px;",'label'=>false,'value' => (isset($investor['Investor']['j_id_expiry']) ? date('Y',strtotime($investor['Investor']['j_id_expiry'])) : date('Y') ),'empty' => (isset($investor['Investor']['j_id_expiry']) ? date('Y',strtotime($investor['Investor']['j_id_expiry'])) : date('Y')), 'class' => 'required')); ?>
                	</div>
				</div>
					<?php
					echo "<span style='font-size: 14px;font-weight: bold; padding: 10px 0px 10px 0px;'>Preferred Mode of Contact</span>".$this->Form->select('j_contact_mode', array('empty' => '-Please select-', '1' => 'Phone', '2' => 'Email'));
					?>
                    </div>
                  </div>
                </div>
                <!-- Step 2 Joint Account Holder Form End -->

                <!-- Step 3 Investment Details Start -->
                ...
                <!-- Step 3 Investment Details End -->
				
				 <!-- Step 4 Bank Details Start -->
                ...
                <!-- Step 4 Bank Details End -->

				<!-- Step 5 Next of Kin Start -->
