...
?></p>
            ...
            <tr>
                <td align="left" valign="top" width="50%">
                    <b style="font-size: 20px; font-weight: bold; display: block; width:90%; height: 100%; background-color: dodgerblue; padding: 10px 10px 10px 10px; text-align: center; border: solid 1px gray; color: #ffffff;">Returns Payment Receipt</b><br />
                    <b style="font-size: 14px;">To: <?php
                            if (isset($payment['Customer']['fullname'])) {
...
?></b>
                ...
                <td align="left" valign="top" width="50%">
                    ...
                    <b>Investor ID: <?php
                        if (isset($payment['Order']['invoice_no'])) {
...
?></p>
        ...
        <table border="0" width="700px" cellspacing="0" cellpadding="5" align="center">
            ...
            <tr>
                ...
                <td align="right" valign="top" width="50%">
<?php
echo $this->Html->link('Back', "/Investments/payments", array("class" => "btn btn-xs btn-info"));
