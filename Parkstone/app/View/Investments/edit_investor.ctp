                            ...
                            <div class="step-pane active" id="step1">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        echo $this->Form->input('investortype_id', array('default' => 2, 'label' => 'Investor Type', 'value' => (isset($investor['Investor']['investortype_id']) ? $investor['Investor']['investortype_id'] : '' ), 'disabled'));
