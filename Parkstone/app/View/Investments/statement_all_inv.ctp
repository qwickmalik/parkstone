...
?>
        ...
        <tr>
            <td align="left" valign="top" width="50%">
                ...
                <b style="font-size: 14px;">To: <?php if (isset($payment['Investor']['fullname']) && !empty($payment['Investor']['fullname'])) {
            ...
            <td align="left" valign="top" width="50%">
                ...
                <b>Investor ID: <?php if (isset($payment['Investor']['id'])) {
...
//                        }
                        ?></td>-->
                        <td align="center"><?php if (isset($each_item['Investment']['custom_rate']) && $each_item['Investment']['custom_rate'] > 0) {
