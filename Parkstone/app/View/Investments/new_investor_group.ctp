...
?>
            ...
            <div class="row">
				...
				<?php
				echo $this->Form->create('Investor', array("enctype" => "multipart/form-data", 'class' =>'basic-form newinvestor',"url" => array('controller' => 'Investments', 'action' => 'commit_group'), "inputDefaults" => array('div' => false))); 
				?>
