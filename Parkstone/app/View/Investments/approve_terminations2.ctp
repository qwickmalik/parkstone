...
<!-- Content starts here -->
<h3>Approve Terminations Step 2: Client Ledger</h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
<?php
...
//                        }
            ...
            <tr style="border-bottom: solid 1px Gray;">
                <td align="right" colspan="2"><p><b>Approve Termination</b></p>
                    <fieldset>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <?php
            echo $this->Html->link('Back', "/Investments/approveTerminations", array("class" => 'btn btn-info'));
