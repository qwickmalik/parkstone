...
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
        <?php echo $this->Form->create('InvestmentDestination', array("url" => array('controller' => 'Reinvestments', 'action' => 'addInvestmentDestination'), "inputDefaults" => array()));
        ?>
        <div class="row">
        ...
        <table border="0" width="100%" cellspacing="10" cellpadding="0" align="left">
            ...
            <?php foreach ($data as $each_item): ?>
                <tr>
                    ...
                    <td align="left"><?php echo $this->Html->link("Delete", "/Reinvestments/delInvestmentDestination/" . $each_item['InvestmentDestination']['id']); ?></td>
                </tr>
            <?php endforeach; ?>
            <tr>
