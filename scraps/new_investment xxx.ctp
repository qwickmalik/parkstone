...
<div class="boxed">
    <div class="inner">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="5" align="left">
            <tr>
                <td align="left" valign="top" colspan="3" ><p class="subtitle-red">Step 1 - Select Un-invested Cash</p></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" valign="middle" colspan="3">
                    ...
                    ?>
                        ...
                        <?php
//                        echo $this->Form->input('search', array('size' => 70, 'class' => 'search', 'value' => (isset($int['Reinvestor']['company_name']) ? $int['Reinvestor']['company_name'] : '' ), 'name' => 'investor_search', 'id' => (isset($int['Reinvestor']['id']) ? $int['Reinvestor']['id'] : '' ), 'label' => false));
                        ?>
                        <!--<input type="hidden" name="hid_investor" value="-->
                            <?php 
//                        (isset($int['Reinvestor']['id']) ? $int['Reinvestor']['id'] : '' ); 
                        ?> 
                        <!--"/>-->

                        <?php 
//                        echo $this->Form->button('Search', array("type" => "submit", "id" => "search", "class" => "btn btn-lg btn-success")); 
                        ?> &nbsp;
