...
<div class="boxed">
	<div class="inner">
			...
			<?php echo $this->Form->create('Equities',array("url" => array('controller' => 'Settings', 'action' => 'equitiesList'),"inputDefaults" => array('label' => false,'div' => false)));?>
			...
			<table border="0" width="100%" cellspacing="10" cellpadding="0" align="left">
				...
				<tr>
					...
					<td>
						<?php echo $this->Form->input('equity_name',array("size" => 40)); echo $this->Form->hidden('id'); ?>
					</td>
					<td align="left">
						<?php 
