...
<h3>Reports: Interest Accrued</h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <table class="table table-striped">
                    <tr>
                        ...
                        <td align="right" valign="top" style="border-bottom: solid 2px Gray;"><b>January</b></td>
                        <td align="right" valign="top" style="border-bottom: solid 2px Gray;"><b>February</b></td>
                        ...
                        <td align="right" valign="top" style="border-bottom: solid 2px Gray;"><b>August</b></td>
                        <td align="right" valign="top" style="border-bottom: solid 2px Gray;"><b>September</b></td>
                        <td align="right" valign="top" style="border-bottom: solid 2px Gray;"><b>October</b></td>
                        <td align="right" valign="top" style="border-bottom: solid 2px Gray;"><b>November</b></td>
                        <td align="right" valign="top" style="border-bottom: solid 2px Gray;"><b>December</b></td>
                    </tr>
                    <tr>
                        <td align="left" valign="top">Name Surname</td>
