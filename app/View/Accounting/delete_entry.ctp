...
<!-- Content starts here -->
<div id="content">
    <h2>Delete Cash Entries</h2>
<div id="clearer"></div>
    <table  cellspacing="10" cellpadding="0" width="100%" border="0" style="background: #fafad2;">
        <?php echo $this->Form->create('CashAccount', array("url" => array('controller' => 'CashAccounts', 'action' => 'deleteEntry'))); ?>
<!--        <tr id="hidrow">
         ...
         <tr>
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <?php 
                                            echo $this->Form->input('from',array('type' => 'date','dateFormat' =>'DMY', 'label'=>false));                                
                                            ?>
                                    </td>
                                    <td align="center" valign="top">
                                        <?php 
                                            echo $this->Form->input('to',array('type' => 'date','dateFormat' =>'DMY', 'label'=>false));                                
                                            ?>
                                    </td>
                                    <td align="center" valign="top">
   ...
   <tr>
                            ...
                            <tr>
                              ...
                              <td width="80" align="left"><?php echo $expensename ?></td>
                              
                              <td width="120" align="left"><?php echo $each_item['Zone']['zone']; ?></td>
                                <td width="80" align="left"><?php echo $each_item['CashAccount']['amount']; ?></td>
                                <td align="left"><?php echo $each_item['CashAccount']['expense_date']; ?></td>
                                <td  align="left"><?php echo $each_item['CashAccount']['remarks']; ?></td>
                                <td width="20" align="left">
                                <?php
                        echo $this->Html->link("Delete", "/CashAccounts/delCash/" . $each_item['CashAccount']['id'], array("class" => $each_item['CashAccount']['id']));
