...
<div id="content">
    ...
    <div id="clearer"></div>
    <?php echo $this->Form->create('Transaction', array("url" => array('controller' => 'Accounting', 'action' => 'assets'), "inputDefaults" => array('div' => false,))); ?>
...
//            echo $this->Form->input('transaction_date', array('type' => 'date', 'value' => isset($ex['Transaction']['transaction_date']) ? date('d-m-Y',strtotime($ex['Transaction']['transaction_date'])) : date('d-m-Y'), 'dateFormat' => 'DMY', 'class' => 'form-control', 'div' => array('class' => 'form-inline')));
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <?php 
                    echo $this->Form->input('headid', array('label' => 'Accounting Head', 'options' => $headids, 'value' => 4, 'disabled' => true));
                    echo $this->Form->hidden('head_id', array('value' => 4));
        //             echo $this->Form->hidden('transaction_type', array('value' => 'Withdrawal'));
                ?>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <?php
                    $msg = 'If Cash is selected here, Cash Account/Repository and Payment Mode become mandatory';
                    $wmsg = 'When editing an entry, DO NOT change category from Cash to any other or vice-versa.';
                    echo $this->Form->input('category_id', array(
                        'required', 
                        'label' => 'Asset Category*'.$this->Html->link($this->Html->image('help.png'), '#', array('rel'=>'tooltip', 'data-placement'=>'top', 'title'=>$msg, 'escape' => false)).$this->Html->link($this->Html->image('warning.png'), '#', array('rel'=>'tooltip', 'data-placement'=>'top', 'title'=>$wmsg, 'escape' => false)), 
                        'empty' => '--Please Select--', 
                        'value' => isset($ex['Transaction']['category_id']) ? $ex['Transaction']['category_id'] : ''
                        ));
                    
                    echo $this->Form->hidden('old_category_id', ['value' => isset($ex['Transaction']['category_id']) ? $ex['Transaction']['category_id'] : '']);
                    ?>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php
                    echo $this->Form->input('account_id', array('label' => 'Cash Account/Repository', 'empty' => '--Please Select--', 'value' => isset($ex['Transaction']['account_id']) ? $ex['Transaction']['account_id'] : ''));
                    ?>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <?php 
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <fieldset>
                        ...
                        echo $this->Form->input('effect', array(
                            ...
                            'hiddenField' => false, 
                            'legend' => false,
                            'before' => '<label>Effect on Asset Category</label><br />',
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <?php echo $this->Form->input('paymentmode_id', array('empty' => '--Please Select--','label' => 'Payment Mode', 'value' => isset($ex['Transaction']['paymentmode_id']) ? $ex['Transaction']['paymentmode_id'] : '')); ?> 
                </div>
...
<!--            <th style="border-bottom: solid 2px dodgerblue;" align="left"><b><?php // echo $this->Paginator->sort('head_id', 'Acc. Head'); ?></b></th>-->
            <th style="border-bottom: solid 2px dodgerblue;" align="left"><b><?php echo $this->Paginator->sort('category_id', 'Asset Category'); ?></b></th>
            <th style="border-bottom: solid 2px dodgerblue;" align="left"><b><?php echo $this->Paginator->sort('account_id', 'Cash Acc/Repository'); ?></b></th>
...
<!--                <td align="left"><?php // echo $each_item['AccountingHead']['head_name']; ?></td>-->
                ...
                <?php
                if ($each_item['Transaction']['random_salt'] == NULL){
                ?>
                    <td align="right"><?php echo $this->Html->link(number_format($each_item['Transaction']['amount'], 2, '.', ','), '/Accounting/assets/' . $each_item['Transaction']['id']); ?></td>
                <?php
                } else {
                    ?>
                    <td align="right"><?php echo number_format($each_item['Transaction']['amount'], 2, '.', ','); ?></td>
                    <?php
                }
                ?>
                ...
                if ($each_item['Transaction']['random_salt'] == NULL){
                ?>
                <td align="left"><?php echo $this->Html->link('Delete', '/Accounting/delAsset/' . $each_item['Transaction']['id'], array('confirm' => 'Are you sure you want to delete?')); ?></td>
                <?php
                } else {
                    ?>
