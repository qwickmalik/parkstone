...
<!--    <div id="panel">
<?php
//echo $this->Html->link($this->Html->image('debtors.png', array('width' => '90', 'height' => '90')), '/Debtors/', array('escape' => false));
?>

        <div id="panel_txt">
            <h2>Debtors</h2>
            <p>Check and update information about clients who have not finished paying for items/services</p>
        </div>
    </div>
