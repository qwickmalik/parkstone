...
<!-- Step Investment Details Start -->
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="5" align="left">
            ...
            <tr>
                <td align="left" valign="top" colspan="3" ><p class="subtitle-red">Step 3 - Fixed Investment</p></td>
            </tr>
            <tr>
                <td align="left" valign="top" colspan="3">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <?php
                        echo $this->Form->input('reinvestor_id', array('label' => 'Re-investor Company','empty' => '--Select Company--', 'disabled'));
//,'selected' => ($this->Session->check('investortemp.investor_type_id') == true ? $this->Session->read('investortemp.investor_type_id') : 1 )
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <?php
                        echo $this->Form->input('notes', array('label' => 'Notes'));
                        ?>  
                    </div>
                     </div>
                </td>
            ...
            <tr>
                <td align="left" valign="top" colspan="3" style="font-size: 18px; color: Red; font-weight: bold;">Investment Details</td>
            </tr>
            <tr>
                <td align="left" valign="top" colspan="3">
