...
<!-- Step Investment Details Start -->
                    <?php
                    echo $this->Form->create('ManageInvestments', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'Reinvestments', 'action' => 'manageInv'), "inputDefaults" => array('div' => false)));
                    ?>
