...
<div class="boxed">
    ...
    <?php
    echo $this->Form->create('DelFixedInvestmentPayments', array("url" => array('controller' => 'Reinvestments', 'action' => 'delFixedInvestmentPayments'), "inputDefaults" => array('label' => false, 'div' => false)));
    ?>
