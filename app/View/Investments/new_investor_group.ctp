					 ...
					 echo $this->Form->input('nature_biz', array('label' => 'Nature of Group', 'value' => (isset($investor['Investor']['nature_biz']) ? $investor['Investor']['nature_biz'] : '' ), 'placeholder' => 'Describe nature of group'));
                                        ...
                                        ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                <?php echo $this->Form->year('date_incorp', 2013, date('Y'), array("id" => "is_year", 'type' => 'date', 'dateFormat' => 'Y', 'size' => 1, "style" => "margin-right: 10px;", 'label' => false, 'value' => (isset($investor['Investor']['date_incorp']) ? date('Y', strtotime($investor['Investor']['date_incorp'])) : '--Select Year--' ), 'empty' => '--Select Year--', 'class' => 'required')); ?>
                                                </div>
                                            </div>
