            ...
            <table id="payment_receipt" border="0" width="700px" cellspacing="0" cellpadding="5" align="center" style="border: solid 1px Gray;">
                ...
                <tr>
                    <td align="left" valign="top" width="50%">
                        <b style="font-size: 20px; font-weight: bold; display: block; width:90%; height: 100%; background-color: dodgerblue; padding: 10px 10px 10px 10px; text-align: center; border: solid 1px gray; color: #ffffff;">Statement: Investment Details</b><br />
                ...
                <tr>
                    <td align="left" valign="top" colspan="2" style="border-top: solid 2px Gray;">
                        <table width="100%" align="left" cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                <td style="border-bottom: solid 2px dodgerblue" align="left"><b>Month<?php // echo $this->Paginator->sort('date', 'Supply Date');   ?></b></td>
                                ...
                                <td style="border-bottom: solid 2px dodgerblue" align="center"><b>Interest (2.5%)</b></td>
