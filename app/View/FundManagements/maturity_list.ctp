...
<h3>Fund Management - Daily Maturity List For <?php echo date('D d M,Y'); ?></h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <table border="0" width="100%" cellspacing="5" cellpadding="5" align="left" style="font-size: 87%">
                    <tr >
                        ...
                        <td style="border-bottom: solid 2px dodgerblue" align="left"><b><?php echo $this->Paginator->sort('Reinvestment_id', 'Company'); ?></b></td>
