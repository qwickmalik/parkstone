...
?>
<!-- Content starts here -->
<h3 style="color: red;">Fund Management - Process Investment</h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
        <!-- Step Investment Details Start -->
        <?php
        echo $this->Form->create('Reinvestment', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'FundManagements', 'action' => 'rolloverReinvestorFixed'), "inputDefaults" => array('div' => false)));
...
//                                            }
                ...
                <div class="col-lg-12 col-md-12 col-sm-12" style="text-align: right;">
                    <?php
                    echo $this->Html->link('Back', "/FundManagements/manageInvFixed/".(isset($reinvestorcashaccounts['ReinvestorCashaccount']['reinvestor_id']) ? $reinvestorcashaccounts['ReinvestorCashaccount']['reinvestor_id'] : '' ), array("class" => 'btn btn-lg btn-info'));
                    echo $this->Form->button('Submit', array("type" => "submit", "class" => "btn btn-lg btn-success"));
                    echo "&nbsp;&nbsp;";
//                    echo $this->Html->link('Submit', "/FundManagements/newInvestment1Fixed1/".(isset($reinvestorcashaccounts['ReinvestorCashaccount']['reinvestor_id']) ? $reinvestorcashaccounts['ReinvestorCashaccount']['reinvestor_id'] : '' ), array("class" => 'btn btn-lg btn-primary'));
                    ?>
                </div>
