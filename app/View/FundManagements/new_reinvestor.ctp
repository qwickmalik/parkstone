...
<!-- Content starts here -->
<h3 style="color: red;">Fund Management - New Investor</h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
        <?php echo $this->Form->create('Reinvestor', array("url" => array('controller' => 'FundManagements', 'action' => 'addReinvestor'), "inputDefaults" => array()));
                ?>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                echo $this->Form->input('currency_id',array('value' => 1));
                ?>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <?php
...
<?php foreach ($data as $each_item): ?>
                <tr>
                    ...
                    <td align="left"><?php echo $this->Html->link("Delete","/FundManagements/delReinvestor/".$each_item['Reinvestor']['id']);   ?></td>
                </tr>
<?php endforeach; ?>
            <tr>
