...
?>
<h3>Cash Deposit Certificate</h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
                            ...
                            <table width="100%" cellspacing="10" cellpadding="0" border="0">
                                ...
                                <tr>
                                    ...
                                    <td><span id="xxxxxx">
                                        ...
                                        if (isset($data_fixed['InvestmentCash']['amount'])) {
                                            echo 'GH$ '. number_format($data_fixed['InvestmentCash']['amount'], 2);
                                        }
                                        ?>
                                        </span></td>   
                                </tr> 
                                ...
                                <tr>
                                    ...
                                    if (isset($data_equity['InvestmentCash']['amount'])) {
                                        echo 'GH$ '.number_format($data_equity['InvestmentCash']['amount'], 2);
                                    }
                                    ?></span></td> 
                                </tr>
            <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td><span id="xxxxxx"><?php
                                        if (isset($total_invested)) {
                                            echo  'GH$ '.number_format($total_invested, 2);
                                        }
                                    ?></span></td>
                                </tr>
...
<?php
echo $this->Html->link('Return', "/FundManagements/newCashDeposit", array('style' => 'font-size: 14px;', 'class' => 'btn btn-lg btn-info'));
