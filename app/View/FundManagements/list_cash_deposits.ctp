...
<h3 style="color: red;">Fund Management - List Cash Deposits</h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
        ...
        <table border="0" width="100%" cellspacing="10" cellpadding="0" align="left">
            <tr>
                ...
                <td style="border-bottom: solid 2px dodgerblue;" align="left">
                    <b><?php echo $this->Paginator->sort('company_name', 'Company'); ?><span style="color:#ff0000">(click on company name to edit)</span></b>
                </td>
                <td style="border-bottom: solid 2px dodgerblue;" align="left">
...
<?php foreach ($data as $each_item): ?>
                <tr>
                    ...
                    <td align="left" >
                        <?php echo $this->Html->link($each_item['Reinvestor']['company_name'], "/FundManagements/editCashDeposit/" . $each_item['ReinvestorDeposit']['id'], array("class" => $each_item['ReinvestorDeposit']['id'])); ?>
                    </td> 
                    <td align="left"><?php echo $each_item['Currency']['currency_name']; ?></td>
                    <td align="left"><?php echo number_format($each_item['ReinvestorDeposit']['fixed_inv_amount'], 2, '.', ','); ?></td>
                    <td align="left"><?php echo number_format($each_item['ReinvestorDeposit']['equity_inv_amount'], 2, '.', ','); ?></td>
                    <td align="left"><?php echo $this->Html->link("Delete","/FundManagements/delCashDeposit/".$each_item['ReinvestorDeposit']['id']);   ?></td>
