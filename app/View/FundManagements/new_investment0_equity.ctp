...
<h3 style="color: red;">Fund Management - Process New Equity Investment</h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        if($each_item['InvestmentCash']['investment_type']=='fixed'):
                            echo $this->Html->link("Select","/FundManagements/newInvestment1Fixed/".$each_item['InvestmentCash']['id']);  
                        elseif ($each_item['InvestmentCash']['investment_type']=='equity'):
                            echo $this->Html->link("Select","/FundManagements/newInvestment1Equity/".(isset($reinvestors['Reinvestor']['id']) ? $reinvestors['Reinvestor']['id'] : '' )."/".$each_item['InvestmentCash']['id']);  
                        endif;
                        ?>
                    </td>
