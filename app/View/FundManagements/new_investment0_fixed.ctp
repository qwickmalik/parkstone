...
<div class="boxed">
    <div class="inner">
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="5" align="left">
            <tr>
                <td align="left" valign="top" colspan="3" ><p class="subtitle-red">Step 2 - Select Un-invested Cash - Fixed Investments</p></td>
            </tr>
            <tr>
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        elseif ($each_item['InvestmentCash']['investment_type']=='equity'):
                            echo $this->Html->link("Select","/FundManagements/newInvestment1Equity/".$each_item['InvestmentCash']['id']);  
                        endif;
                        ?>
                    </td>
