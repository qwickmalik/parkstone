...
<div class="boxed">
    <div class="inner">
        ...
        <?php echo $this->Form->create('PaymentFixedReceipt', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'FundManagements', 'action' => 'makePayment'), "inputDefaults" => array('div' => false))); ?>
...
<div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12" >
            <?php
            echo "<p>&nbsp;</p>";
            echo $this->Html->link('Done', "/FundManagements/manageInvFixed/".(isset($reinvestments['Reinvestment']['reinvestor_id']) ? $reinvestments['Reinvestment']['reinvestor_id'] : ''), array("style"=>"float: right;","class" => 'btn btn-lg btn-info'));
