...
<div class="boxed">
    <div class="inner">
        ...
        <?php
        echo $this->Form->create('Reinvestment', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'FundManagements', 'action' => 'processTermination'), "inputDefaults" => array('div' => false)));
        ?>
...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <?php
                        if (isset($data['Reinvestment']['investment_amount'])) {
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                <div class="row">
                    ...
                    echo $this->Form->input('investmentdestination_id', array('disabled', 'empty' => '--Please Select--',
                ...
                <div class="row" >
                 <?php  echo "<p>&nbsp;</p>"; ?>
                        <?php
                         echo $this->Form->input('cashreceiptmode_id', array('required', 'label' => 'Cash Receipt Mode', 'empty' => '--Please Select--'));
                         ?>
...
<?php echo $this->Form->year('investment_date', 1950, date('Y'), array("selected" => $Year, "class" => "large")); ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12" style="text-align: right;">
            <?php
//                    echo $this->Html->link('Back', "/FundManagements/newInvestment", array("class" => 'btn btn-lg btn-info'));
            echo $this->Form->button('Process', array("type" => "submit", "class" => "btn btn-lg btn-success"));
            echo "&nbsp;&nbsp;";
            echo $this->Html->link('Save', "/FundManagements/manageInvFixedCancel/" . (isset($data['Reinvestment']['id']) ? $data['Reinvestment']['id'] : '' ) . "/" . (isset($reinvestorcashaccounts['ReinvestorCashaccount']['reinvestor_id']) ? $reinvestorcashaccounts['ReinvestorCashaccount']['reinvestor_id'] : '' ), array("class" => 'btn btn-lg btn-primary'));
            ?>
        </div>
