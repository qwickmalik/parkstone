...
?>
<!-- Content starts here -->
<h3 style="color: red;">Fund Management Payment</h3>
<div class="boxed">
    <div class="inner">
        <div id="clearer"></div>

        <?php echo $this->Form->create('Reinvestment', array('enctype' => 'multipart/form-data', "url" => array('controller' => 'FundManagements', 'action' => 'makePayment'), "inputDefaults" => array('div' => false))); ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12" style="float: right;">
            <?php
            echo "<p>&nbsp;</p>";
            echo $this->Html->link('Back', "/FundManagements/manageInvFixed/".(isset($reinvestments['Reinvestment']['reinvestor_id']) ? $reinvestments['Reinvestment']['reinvestor_id'] : ''), array("style"=>"float: right;","class" => 'btn btn-lg btn-info'));
//            echo $this->Html->link('Make Payment', "/FundManagements/makePayment", array("class" => 'btn btn-lg btn-success'));
