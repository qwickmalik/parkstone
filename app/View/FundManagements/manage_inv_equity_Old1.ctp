        ...
        <table border="0" width="100%" cellspacing="10" cellpadding="0" align="left">
            ...
            <?php foreach ($data as $each_item): ?>
                <tr>
                    ...
                    <td align="left">
                        <?php 
                            echo $this->Html->link("Details","/FundManagements/manageInvEquityDetails/".$each_item['Reinvestment']['id']);  
                            echo " | ";
                            echo $this->Html->link("Cancel","/FundManagements/manageInvEquityCancel/".$each_item['Reinvestment']['id']);  
                            echo " | ";
                            echo $this->Html->link("Pay","/FundManagements/payReinvestor/".$each_item['Reinvestment']['id']);  
                        ?>
                    </td>
